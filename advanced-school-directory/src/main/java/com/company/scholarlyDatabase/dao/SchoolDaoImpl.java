...
public class SchoolDaoImpl implements SchoolDao {
    ...
    /*
    * I added SQL queries to my methods below.
    * The SQL statements had to be completely inside the quotation marks
    * in Java variable like this below:
    *   String sql = "";
    *
    * P.S.
    *   - Strings will be inside single quotation marks (' ').
    *   - Strings are case-sensitive.
    *   - Semi-colons are optional at the end of the SQL queries.
     */
